...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <h3>Updating an Item in an Array the title</h3>
            ...
            <h3>Updating an Item in an Array the description</h3>
            ...
            <h3>Updating an Item in an Array the completed</h3>
            <a href={`${API}/${todo.id}/completed/${todo.completed}`} className="btn btn-primary float-end">
                Update Todo completed</a>
            <input defaultValue={todo.id} className="form-check w-25 float-start me-2"
                onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
            <input type="checkbox" checked={todo.completed} className="form-check w-50 float-start"
